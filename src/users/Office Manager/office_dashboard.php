...
<div class="content">
    ...
    <div class="row gy-3 mb-6 justify-content-between">
        <div class="col-md-8 col-auto">
            <h2 class="mb-2 text-1100">Office Manager Dashboard</h2>
        ...
        <div class="col-md-4 col-auto">
            ...
            <button class="btn btn-sm btn-success ml-3 mt-2" data-bs-toggle="modal" data-bs-target="#add_subs">
                Add More Suburb +
            </button>
            <button class="btn btn-sm btn-warning ml-3 mt-2" data-toggle="modal" data-target="#add_subs">
            Add a Nurse +
            </button>
